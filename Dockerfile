# This is based on https://github.com/phadej/docker-haskell-example

FROM ubuntu:18.04 AS builder
LABEL author="Ryo Iketani"
...
RUN cabal v2-install cabal-plan --constraint='cabal-plan ^>=0.7.2' --constraint='cabal-plan +exe'
